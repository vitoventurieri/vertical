...
if __name__ == '__main__':
	...
	covid_parameters, model_parameters, output_parameters = get_input_data(IC_analysis = 4, city=city_code)
	...
	plots(results, covid_parameters, model_parameters, plot_dir, place=city+'/'+state)
