...
def get_input_data():
    ...
    model_parameters = model_parameters(
        ...
        init_exposed_elderly= Ei0, #1, #    # initial exposed population old ones: 55+ years
        init_exposed_young= Ej0,   #1, #    # initial exposed population young ones: 0-59 years
        init_infected_elderly= Ii0,#1, #    # initial infected population old ones: 60+ years 
        init_infected_young= Ij0, #1, #     # initial infected population young ones: 0-59 years (based in the proportion of elderly of a total of 22727 cases in the last 10 days within a total of 38654 cumulative confirmed cases in 19/04/2020 17:00 GMT-3 - source https://covid.saude.gov.br/)
        ...
        t_max=1*365 	                    # number of days to run
    )
