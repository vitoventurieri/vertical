...
def parameter_for_rt_fit_analisys(city):
    ...
    df_wcota = pd.read_csv('data\cases-brazil-cities-time.csv', sep=',') #source #dataset source : https://github.com/wcota/covid19br/blob/master/README.md -  W. Cota, “Monitoring the number of COVID-19 cases and deaths in brazil at municipal and federative units level”, SciELOPreprints:362 (2020), 10.1590/scielopreprints.362 - license (CC BY-SA 4.0) acess 30/07/2020 
    ...
    df_cidade = df_wcota.loc[(df_wcota.ibge_code_trimmed == codigo_da_cidade_ibge) & (df_wcota.deaths >= 50)].reset_index()
